...
;(function() {
     ...
     */
    Scroller = function(callback, content, options) {
        ...
        this.options = {
            ...
            /** Callback for when grid has snapped and finished. */
            snapped: NOOP,
    ...
    var members = {
        ...
        */
        ...
        /**
         * Returns position of the snapped element
         *
         * @return int
         */
        getSnappedXPos: function() {
            var self = this

            var left = self.__scrollLeft
            var size = self.__snapWidth
        ...
        scrollTo: function(left, top, animate, zoom) {
            ...
            if (!self.options.scrollingX) {
                ...
                if (self.options.paging) {
                    left =
                        Math.round(left / self.__clientWidth) *
                        self.__clientWidth
                } else if (self.options.snapping) {
                    left =
                        Math.round(left / self.__snapWidth) * self.__snapWidth
                }
            }
            ...
            if (!self.options.scrollingY) {
                ...
                if (self.options.paging) {
                    top =
                        Math.round(top / self.__clientHeight) *
                        self.__clientHeight
                } else if (self.options.snapping) {
                    top =
                        Math.round(top / self.__snapHeight) * self.__snapHeight
                }
            }
        ...
        doTouchMove: function(touches, timeStamp, scale) {
            ...
            if (self.__isDragging) {
                ...
                if (scale != null && self.options.zooming) {
                    ...
                    if (oldLevel !== level) {
                        ...
                        var currentTouchLeftRel =
                            currentTouchLeft - self.__clientLeft
                        var currentTouchTopRel =
                            currentTouchTop - self.__clientTop

                        // Recompute left and top coordinates based on new zoom level
                        scrollLeft =
                            (currentTouchLeftRel + scrollLeft) *
                                level /
                                oldLevel -
                            currentTouchLeftRel
                        scrollTop =
                            (currentTouchTopRel + scrollTop) *
                                level /
                                oldLevel -
                            currentTouchTopRel
                ...
                var distanceX = Math.abs(
                    currentTouchLeft - self.__initialTouchLeft
                )
                var distanceY = Math.abs(
                    currentTouchTop - self.__initialTouchTop
                )

                self.__enableScrollX =
                    self.options.scrollingX &&
            ...
            if (self.__isDragging) {
                ...
                if (
                    ...
                    if (startPos !== endPos) {
                        ...
                        var movedLeft =
                            self.__scrollLeft - positions[startPos - 2]
                        var movedTop =
                            self.__scrollTop - positions[startPos - 1]
        ...
        */
        ...
        __publish: function(left, top, zoom, animate) {
            ...
            if (animate && self.options.animating) {
                ...
                self.__isAnimating = scroller.effect.Animate.start(
                    step,
                    verify,
                    completed,
                ...
                // Push values out
                if (self.__callback) {
                    self.__callback(self.__content, left, top, zoom)
                }
        ...
        */
        ...
        __startDeceleration: function(timeStamp) {
            ...
            self.__isDecelerating = scroller.effect.Animate.start(
                step,
                verify,
                completed
            )
        ...
        __stepThroughDeceleration: function(render) {
            ...
            if (self.options.bouncing) {
                ...
                var penetrationDeceleration =
                    self.options.penetrationDeceleration
                var penetrationAcceleration =
                    self.options.penetrationAcceleration

                // Check limits
                if (scrollLeft < self.__minDecelerationScrollLeft) {
                    scrollOutsideX =
                        self.__minDecelerationScrollLeft - scrollLeft
                } else if (scrollLeft > self.__maxDecelerationScrollLeft) {
                    scrollOutsideX =
                        self.__maxDecelerationScrollLeft - scrollLeft
                }
